...
<div class="col-md-6 mb-3">
    ...
    @enderror
                    ...
                    <div class="col-md-12 mb-3">
                        ...
                        >{{ old('short_description', $client->short_description) }}</textarea>
                    ...
                    <div class="col-md-12 mb-3">
                        ...
                        <input
                            ...
                            value="{{ old('seo_title', $client->seo_title) }}"
                        >
                    ...
                    <div class="col-md-12 mb-3">
                        ...
                        >{{ old('seo_keywords', $client->seo_keywords) }}</textarea>
                    ...
                    <div class="col-md-12 mb-3">
                        ...
                        >{{ old('seo_description', $client->seo_description) }}</textarea>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        const removeButton = document.getElementById('remove-logo-btn');
